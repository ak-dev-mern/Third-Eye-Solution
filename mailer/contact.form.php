...
$recipientName = "Third Eye Solution";

// Recipient email. Change this email to your
$recipientEmail = "thirdeyesolutions3@gmail.com";
...
if ($useSMTP) {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'thirdeyesolutions3@gmail.com';
    $mail->Password = 'wxrh muls vyku wfma';
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;
} else {
